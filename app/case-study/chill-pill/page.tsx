    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 pt-16">
        ...
        <div className="container animate-on-load animate-fade-in-up animate-delay-400 px-4 md:px-0">
          ...
          {/* Problem */}
          <div className="max-w-[1140px] mx-auto mb-16 animate-on-load animate-fade-in-up animate-delay-500 px-4 md:px-6">
          ...
          {/* Solution */}
          <div className="max-w-[1140px] mx-auto mb-16 animate-on-load animate-fade-in-up animate-delay-600 px-4 md:px-6">
